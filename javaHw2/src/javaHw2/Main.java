...
public class Main {
	...
	public static void main(String[] args) {
		...
		Courses courseJava = new Courses(1,"www.kursfotografi.com","Yazılım Geliştirici Yetiştirme Kampı Java + React","2 ay sürecek Yaılım Geliştirici Yetiştirme Kampımızı takip...","Ücretsiz");
		...
		Courses coursePrograming = new Courses(1,"www.kursfotografi.com","Programlamaya Giriş İçin Temel Kurs","Python, Java gibi...","Ücretsiz");
